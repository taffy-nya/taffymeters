...
impl Panel {
    ...
    pub fn draw(
        ...
        if self.overlay_open { return self.draw_overlay(ui, rect, salt, multi, theme); }
        self.draw_split_edges(ui, rect, salt, theme)
    }
    ...
    fn draw_split_edges(&self, ui: &mut egui::Ui, rect: egui::Rect, salt: usize, theme: &Theme) -> PanelAction {
        const E: f32 = 20.0;
